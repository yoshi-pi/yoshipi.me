export function getLocalizedMessages(lang: 'ja' | 'en') {
  const messages = {
    en: {
      ...
      productions: '<a href="https://jsontocsvconv.com/">json to csv</a> / <a href="https://echoserver.dev/">echoserver</a> / <a href="https://www.amazon.com/dp/B0DHX2BFZ6">Interval Timer(Alexa Skill)</a>',
      hobby:
        'Walking / Traveling / Sauna / Karaoke / Comedy / Anime / Sports / Mahjong / Poker / Photography(<a href="https://www.instagram.com/yoshipigram2/">instagram</a>)',
    ...
    ja: {
      ...
      productions: '<a href="https://jsontocsvconv.com/">json to csv</a> / <a href="https://echoserver.dev/">echoserver</a> / <a href="https://www.amazon.co.jp/dp/B0DHX2BFZ6">インターバルタイマー(Alexa Skill)</a>',
      hobby: '散歩/旅行/サウナ/カラオケ/お笑い/アニメ/スポーツ/麻雀/ポーカー/カメラ(<a href="https://www.instagram.com/yoshipigram2/">instagram</a>)',
      contact:
