export function getLocalizedMessages(lang: 'ja' | 'en') {
  const messages = {
    en: {
      ...
      hobby:
        'Walking / Traveling / Sauna / Karaoke / Comedy / Anime / Sports / Mahjong / Poker / Photography(<a href="https://www.instagram.com/yoshipigram/">instagram</a>)',
    ...
    ja: {
      ...
      hobby: '散歩/旅行/サウナ/カラオケ/お笑い/アニメ/スポーツ/麻雀/ポーカー/カメラ(<a href="https://www.instagram.com/yoshipigram/">instagram</a>)',
      contact:
